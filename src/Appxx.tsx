      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-20">
          ...
          <div className="flex-1 w-full">
            <div className="relative aspect-video rounded-[2rem] overflow-hidden shadow-2xl ring-1 ring-white/20">
              {/* Video (selalu ada, tapi hidden kalau belum play) */}
              <video 
                ref={videoRef}
              ...
              {/* Overlay thumbnail & play button (hilang saat playing) */}
              {!isPlaying && (
                <>
                  <div className="absolute inset-0 bg-black/50">
                    <img 
                      src="/assets/thumb-video1.png" 
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <button 
                      ...
                      className="w-20 h-20 bg-primary text-white rounded-full flex items-center justify-center shadow-2xl transition-transform hover:scale-110 cursor-pointer z-10"
                    >
