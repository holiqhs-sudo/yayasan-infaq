...
// --- Logo Constant ---
const LOGO_URL = "https://static.wixstatic.com/media/878df0_9407310567e94447833054174620f512~mv2.png/v1/fill/w_600,h_221,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/878df0_9407310567e94447833054174620f512~mv2.png";
    ...
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${scrolled ? 'glass-nav py-3 shadow-md' : 'bg-transparent py-6'}`}>
      <div className="container mx-auto px-6 flex items-center justify-between">
        <div className="flex items-center">
          <a href="#" className="block h-10 lg:h-14 transition-transform hover:scale-105">
            <img 
              src={LOGO_URL} 
        ...
        <div className="hidden lg:flex items-center gap-10">
          <NavLink href="#kenali">Kenali Kami</NavLink>
          <NavLink href="#program">Program Utama</NavLink>
          <NavLink href="#kerja">Kerja Kami</NavLink>
          <NavLink href="#sertai">Sertai Kami</NavLink>
          <NavLink href="#hubungi">Hubungi Kami</NavLink>
        </div>
      ...
      {isOpen && (
        <div className="lg:hidden absolute top-full left-0 right-0 bg-white shadow-2xl border-t border-slate-100 py-10 px-8 flex flex-col gap-8 animate-in slide-in-from-top duration-500">
          <NavLink href="#kenali" onClick={() => setIsOpen(false)}>Kenali Kami</NavLink>
          <NavLink href="#program" onClick={() => setIsOpen(false)}>Program Utama</NavLink>
          <NavLink href="#kerja" onClick={() => setIsOpen(false)}>Kerja Kami</NavLink>
          <NavLink href="#sertai" onClick={() => setIsOpen(false)}>Sertai Kami</NavLink>
          <NavLink href="#hubungi" onClick={() => setIsOpen(false)}>Hubungi Kami</NavLink>
            ...
            <div className="lg:col-span-4">
              ...
              <ul className="space-y-6 font-body">
                ...
                <li className="flex items-center gap-5 text-slate-700 font-extrabold text-base lg:text-lg">
                  ...
                  <a href="tel:+60199999468" className="hover:text-primary transition-colors">+6019 9999 468</a>
                </li>
                <li className="flex items-center gap-5 text-slate-700 font-extrabold text-base lg:text-lg">
